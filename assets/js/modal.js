...
// - Scroll lock robusto (iOS safe)
// - Lee timings de CSS vars: --modal-close-ms / --modal-open-ms
// - Backdrop click, ESC, focus trap, restore focus
// - (opcional) integración con Fancybox: data-clear-gallery / data-gallery-target
